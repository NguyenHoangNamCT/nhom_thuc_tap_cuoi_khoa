...
class HOADON{
    ...
    public function layDanhSachHoaDon() {
        $db = DATABASE::connect();
        try {
            $sql = "SELECT hoadon.*, donhang.id_nguoi_dung, donhang.ngay_dat, donhang.dia_chi_giao_hang, donhang.dien_thoai_nguoi_nhan, donhang.ho_ten_nguoi_nhan, donhang.tong_tien, donhang.tinh_trang_don_hang
            FROM hoadon
